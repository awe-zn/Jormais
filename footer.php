  <!-- <footer class="bg-teal">
    <div class="container mt-awe-56 pb-awe-32">
      <div class="pt-awe-32">
        <div class="row pt-awe-24">
          <div class="col-12 col-md-6 col-lg-5 d-flex flex-column">
            <div>
              <img src="<?php echo get_template_directory_uri(); ?>/dist/img/logo-footer.png" alt="">
            </div>
            <div class="d-flex gap-awe-32 ps-awe-64 mt-awe-32">
          ...
          <div class="col-12 col-md-5 col-lg-7">
            <nav class="d-flex gap-awe-16 gap-awe-md-24 justify-content-end flex-wrap flex-column flex-sm-row">
              <a href="mailto:portaljormais@gmail.com" class="text-white text-decoration-none">
  ...
  <footer class="bg-teal">
    <div class="container py-awe-32">
      <div class="row">
        ...
        <div class="col-12 col-md-4 col-lg-3 offset-lg-1 d-flex flex-column align-items-center">
